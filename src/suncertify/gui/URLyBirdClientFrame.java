...
/**
 * This class extends URLyBirdApplicationFrame to display the client Frame User Interface for the user to interact with
 * @author Segun
 */
public class URLyBirdClientFrame extends URLyBirdApplicationFrame{

    private URLyBirdClientFrame self = this;
    ...
    /**
     * This one constructor constructs the client frame passing the Object instance of the RemoteURLyBirdServices instance making all available
     * remote functions for the remote service be available for use in this User Interface (JFrame)
     * @param s Instance of the remote services to be used 
     */
    public URLyBirdClientFrame(RemoteURLyBirdServices s){
        super("URLyBird | CLIENT MODE");
        services = s;
    }
    ...
    public void loadActions(){
            ...
            public void actionPerformed(ActionEvent e){
                try{                   
                   ...
                   URLyBirdStatusHandler.setStatus(statusLbl, URLyBirdStatusOption.ERROR, 
                    ...
                    JOptionPane.showMessageDialog(self, rE.getMessage(), "REMOTE ERROR", JOptionPane.ERROR_MESSAGE);
                    URLyBirdStatusHandler.setStatus(statusLbl, URLyBirdStatusOption.ERROR, 
                        rE.getMessage());
                }
                finally{
                ...
                new NewURLyBirdHotelDialog(self) {
                    ...
                    public void add() {
                        try{
                            ...
                            JOptionPane.showMessageDialog(this, rE.getMessage(), "REMOTE ERROR", JOptionPane.ERROR_MESSAGE);
                            URLyBirdStatusHandler.setStatus(statusLbl, URLyBirdStatusOption.ERROR, 
                                    rE.getMessage());
                        }
                        finally{
        ...
        configItem.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                SwingUtilities.invokeLater(new Runnable(){
                    public void run(){
                        URLyBirdConfigDialog configDialog = new URLyBirdConfigDialog((URLyBirdServices)services, self);
        ...
        aboutItem.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                SwingUtilities.invokeLater(new Runnable(){
                    public void run(){
                        JOptionPane.showMessageDialog(self, "<html><pstyle='text-align:center;'>&copy;2011 Oracle URLyBird Client Version 1.1</p>"
                                + "</html>", "About", 
                            JOptionPane.PLAIN_MESSAGE);                     
                    }
                });                 
